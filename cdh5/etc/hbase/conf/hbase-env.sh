...
export HBASE_HEAPSIZE="{{ pillar.cdh5.hbase.master_max_heap }}"
{% elif 'cdh5.hbase.regionserver' in grains.roles %}
export HBASE_HEAPSIZE="{{ pillar.cdh5.hbase.region_max_heap }}"
{% endif %}
...
export HBASE_LOG_DIR={{ pillar.cdh5.hbase.log_dir }}
